...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   /* protected*/ public void onCreate(Bundle savedInstanceState) {
        ...
        //yehan pa hum na ids define kre ,aur necha onClick ko define kr dia
    ...
    @Override
    /*protected*/ public void onActivityResult(int requestCode, int resultCode, Intent data) {
