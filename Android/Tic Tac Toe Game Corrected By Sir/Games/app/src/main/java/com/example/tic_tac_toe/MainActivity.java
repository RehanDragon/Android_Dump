...
// ya humara on click view listener ka alternate way ha
    // hum hr button k click pa click listner lga ta aur condition lg ta , humna ya kra k switch lga dia
    ...
    // aubhe ActivePlayer hum na 1 k bra ber kr dia
...
//try
        try {
            ...
            // yehan pa values swap ho rahe hain

            // pehla hum na Active player ko aupar one kra
            if (ActivePlayer == 1) {
                buSelected.setText("X");
                buSelected.setBackgroundColor(Color.RED);
                Player1.add(CellID);

                // aus k bad ActivePlayer k variable ke value ko hum na 2 kra ,aub aus main 2 store ho chuka ha
                ActivePlayer = 2;
            ...
            if (Winer != -1) {
                ...
                if (Winer == 1) {
                   // Toast.makeText(this, "Player 1 is winner", Toast.LENGTH_LONG).show();
                    ...
                    dialog.setMessage("Player 1 win want to continue?" );
                ...
                //    Toast.makeText(this, "Player 2 is winner", Toast.LENGTH_LONG).show();
                    ...
                    dialog.setMessage("Player 2 win want to continue?" );
                    dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int id) {
                            //Action for "Delete".
