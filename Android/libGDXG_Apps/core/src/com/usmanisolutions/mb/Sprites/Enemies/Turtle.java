...
public class Turtle extends Enemy{
    ...
    public Turtle(PlayScreen screen, float x, float y) {
        ...
        setBounds(getX(), getY(), 16 / MB.PPM, 24 / MB.PPM);
    ...
    public TextureRegion getFrame(float dt){
        ...
        switch (currentState){
            ...
            case WALKING:
            default:
//                yehan pa bhe cast kia ha (TextureRegion) ager msla aye to htana
    ...
    public void update(float dt) {
        ...
        setPosition(b2body.getPosition().x - getWidth() / 2, b2body.getPosition().y - 8 /MB.PPM);
