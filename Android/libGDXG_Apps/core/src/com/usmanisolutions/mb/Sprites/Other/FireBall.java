package com.usmanisolutions.mb.Sprites.Other;
...
public class FireBall extends Sprite{
    ...
    public FireBall(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        setBounds(x, y, 6 / MB.PPM, 6 / MB.PPM);
        defineFireBall();
    }

    public void defineFireBall(){
        BodyDef bdef = new BodyDef();
        bdef.position.set(fireRight ? getX() + 12 /MB.PPM : getX() - 12 /MB.PPM, getY());
        ...
        shape.setRadius(3 / MB.PPM);
        fdef.filter.categoryBits = MB.FIREBALL_BIT;
